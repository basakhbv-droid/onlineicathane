...
<section class="hero">
  ...
  <p>C++, Arduino ve Tinkercad ile teknoloji dünyasına adım at. 9–15 yaş arası öğrenciler için tasarlandı.</p>
  <div class="hero-btns">
...
<script>
const SYSTEM_PROMPT = `Sen CodeLab adlı bir kodlama ve teknoloji eğitim sitesinin AI asistanısın.
Ortaokul ve lise öğrencilerine (9-15 yaş) yardım ediyorsun.
Konu alanların: C++ programlama, Arduino/elektronik, Tinkercad 3D tasarım.
 
Kurallar:
- Her zaman Türkçe cevap ver
- Yaşa uygun, sade ve anlaşılır dil kullan
- Kod örnekleri verirken kısa ve basit tut
- Bol teşvik et, hataları nazikçe düzelt
- Konudan çıkan sorularda nazikçe geri yönlendir
- Cevaplar kısa olsun (maksimum 3-4 paragraf)`;
...
async function sendMessage() {
  ...
  try {
    ...
    document.getElementById('typing')?.remove();
    addMsg('bot', 'Bağlantı hatası oluştu. Lütfen tekrar dene. 🔄');
  }
